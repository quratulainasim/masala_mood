...
export default function FeaturedDishes() {
  ...
  const dishes = [
    ...
    { name: t("Broast Chicken", "بروسٹ چکن"), price: "$12", rating: 4.7, tag: t("Popular", "مقبول"), image: broast, desc: t("Crispy pressure-fried chicken, juicy inside, golden outside", "کرسپی فرائیڈ چکن، اندر سے رسیلا، باہر سے سنہرا") },
  ];
